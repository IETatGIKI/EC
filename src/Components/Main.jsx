            ...
            >
                <div id='crd' className="container crd p-0 m-0">
                    <div className="row p-3 m-1">
                        ...
                        <div className={`${click === 8 ? 'col-md-8' : 'd-none'} three`}>
                        ...
                        <div className={`${click === 2 ? 'col-md-8' : 'd-none'} nine`}>
                        ...
                        <div className={`${click === 1 ? 'col-md-8' : 'd-none'} ten`}>
                        ...
                        <div className={`${click === 0 ? 'col-md-8' : 'd-none'} ten`}>
